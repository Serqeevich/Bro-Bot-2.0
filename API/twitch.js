...
async function getAuthKey(clientID, clientSecret) {
...
async function getStreamsData(channelName, clientID, authkey) {
    return new Promise((resolve, reject) => {
        var headers = {
            'Client-Id': clientID,
            'Authorization': `Bearer ${authkey}`
...
module.exports = { getAuthKey, getChannelData, getStreamsData };