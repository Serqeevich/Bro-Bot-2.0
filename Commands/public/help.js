    ...
    async execute(interaction, client) {
        ...
        if (member.permissions.has(PermissionFlagsBits.Administrator)) {
            description +=
                ...
                + `**4.** \`/premium\` - список Premium участников.\n`
                + `**5.** \`/premium-add\` - добавить участнику Premium.\n`
                + `**6.** \`/premium-remove\` - удалить участнику Premium.\n`
                + `**7.** \`/private-rooms\` - список приватных комнат.\n`
                + `**8.** \`/send-message\` - отправить сообщение от имени бота.\n`
                + `**9.** \`/news\` - опубликовать новость.\n`
                + `━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n`
        }
